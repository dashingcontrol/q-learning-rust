...
The episode-100 path happens to be shortest in this seeded run. It is still a training sample, not a clean
test of the learned policy, because epsilon is still $0.02$. That distinction is why the program saves a
separate greedy evaluation.
