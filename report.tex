...
\end{equation}
In the maximum term, the program checks only moves available from the next cell. It ignores moves into walls
or outside the maze. At the goal, the future term is zero. For the first update, all stored values are zero, so
\[
